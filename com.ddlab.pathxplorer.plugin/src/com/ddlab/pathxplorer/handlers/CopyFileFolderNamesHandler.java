...
/**
 * The Class CopyFileFolderNamesHandler.
 * 
 * @author Debadatta Mishra (PIKU)
 */
public class CopyFileFolderNamesHandler extends AbstractHandler {
	...
	public Object execute(ExecutionEvent event) throws ExecutionException {
		...
		try {
			List<String> pathsList = CommonUtil.getFileFolderPath(structuredSelection);
			StringBuilder sb = new StringBuilder();
			for (String paths : pathsList) {
				sb.append(paths).append("\r\n");
			}
			CommonUtil.copyTextToClipBoard(new String[] { sb.toString() });
